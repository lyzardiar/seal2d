...
-- local bottom_bar
-- local bottom_bar_title = ""
-- local bottom_bar_content = {}
...
--     local function fade_out_test()
--         return action.fade_to(2, 0)
--     end

--     local tests = {
--         name = "fade_out", create_func = fade_out_test,
--     }

--     bottom_bar_content = tests
